...
- **Outbox Pattern:** Outbox processors MUST use a Dispatcher/Handler pattern to comply with SRP/OCP. Batch processing involving I/O MUST use concurrent execution with controlled parallelism.
